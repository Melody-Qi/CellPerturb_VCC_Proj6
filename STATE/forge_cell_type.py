...
adata_hvg = ad.read_h5ad("./preprocessed_data/preprocessed_training_data_1000.h5ad")
...
# 保存新的 h5ad
adata_hvg.write_h5ad("./preprocessed_data/preprocessed_training_data_1000_with_obs.h5ad")
