...
# 保存文件（英文文件名）
adata_val.write_h5ad("validation_set.h5ad")
adata_test.write_h5ad("test_set.h5ad")
adata_train.write_h5ad("training_set.h5ad")

print("保存完成：validation_set.h5ad, test_set.h5ad")