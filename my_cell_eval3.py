...
if __name__ == '__main__':
    ...
    main_eval("./STATE/competition_support_set/competition_train.h5",
              "./STATE/checkpoints/forth_run20251202/baseline_lognorm.h5ad",
              "./STATE/checkpoints/forth_run20251202/name",
              "./STATE/checkpoints/forth_run20251202/de_result/adata_T_de_results.csv",
              "./STATE/checkpoints/forth_run20251202/de_result/pred_de_results.csv")
